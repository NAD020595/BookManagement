namespace BookManagement.ConsoleApp.View
{
    using Model;

    internal class BookSingleView
    {
        protected BookModel Model; // biến này để lưu trữ thông tin cuốn sách đang cần hiển thị

        /// <summary>
        /// đây là hàm tạo, sẽ được gọi đầu tiên khi tạo object
        /// </summary>
        /// <param name="model">cuốn sách cụ thể sẽ được hiển thị</param>
        public BookSingleView(BookModel model)
        {
